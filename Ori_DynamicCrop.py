...
def testModel():
    ...
    # for i in range(total-1, -1, -1):
        ...
        '''crop_coord[0] = int(min_x) #crop_add_width_length)
        crop_coord[1] = int(min_y) #crop_add_height_length)
        crop_coord[2] = int(max_x) #crop_add_width_length)
        crop_coord[3] = int(max_y) #crop_add_height_length)'''
